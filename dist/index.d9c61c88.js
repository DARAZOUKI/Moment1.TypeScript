...
})({"bNCnv":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "961d4577d9c61c88";
"use strict";
...
var CourseManager = /** @class */ function() {
    ...
    CourseManager.prototype.handleFormSubmit = function() {
        ...
        } else alert("A course with the same code already exists. Please enter a unique code.");
    };
    CourseManager.prototype.isCourseCodeUnique = function(code) {
        return !this.courses.some(function(course) {
    ...
    CourseManager.prototype.clearCourses = function() {
        ...
        var kursInfo = document.getElementById("course-list");
        if (kursInfo) kursInfo.innerHTML = ""; // Clear displayed courses
    };
    CourseManager.prototype.handleUpdate = function() {
        ...
        var updated = false;
        for(var i = 0; i < this.courses.length; i++)if (this.courses[i].code === updateCodeInput) {
        ...
        } else console.log("Course with code ".concat(updateCodeInput, " not found."));
    };
    return CourseManager;
}();
new CourseManager();

},{}]},["bNCnv","8iAxt"], "8iAxt", "parcelRequiree6de")
